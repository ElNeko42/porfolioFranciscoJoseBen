...
const about: About = {
  ...
  education: {
    ...
    list: [
      {
        title: 'Bootcamp en Análisis de Datos e Inteligencia Artificial',
        institution: 'Hack A Boss',
        url: '',
        description:
          'Programa intensivo enfocado en análisis de datos y desarrollo de soluciones de inteligencia artificial, preparando a los estudiantes para enfrentar desafíos tecnológicos avanzados.',
        startDate: '2024-01',
        endDate: '2024-06',
        courses: [
          'Análisis de datos',
      ...
      },
      {
        ...
        url: '',
        description:
          'Programa técnico enfocado en el desarrollo de aplicaciones móviles y de escritorio, utilizando frameworks modernos y metodologías ágiles.',
        startDate: '2017-09',
        endDate: '2019-06',
        courses: [
      ...
      {
        title: 'FP Medio en Preimpresión Digital',
        institution: 'IES Calvo Sotelo',
        url: '',
        description:
          'Curso técnico centrado en la preparación y producción de material gráfico digital, con conocimientos en diseño gráfico y manejo de software especializado.',
        startDate: '2015-09',
        endDate: '2017-06',
        courses: [
